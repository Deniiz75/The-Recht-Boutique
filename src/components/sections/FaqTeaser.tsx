...
export function FaqTeaser({ index }: { index?: string }) {
  return (
    <section aria-labelledby="faq-titel" className="border-t border-gold/30 bg-canvas">
      <Container>
        <div className="grid gap-12 py-20 lg:grid-cols-12 lg:gap-16 lg:py-28">
          <div className="lg:col-span-4">
            ...
            <Link
              ...
              className="group reveal mt-9 inline-flex min-h-11 items-center gap-3 font-mono text-[0.6875rem] tracking-[0.2em] text-ink uppercase"
            >
