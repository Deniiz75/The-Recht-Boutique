...
export function IntroTeaser() {
  return (
    <section aria-labelledby="intro-titel" className="bg-paper">
      <Container>
        <div className="grid gap-10 border-b border-line py-20 lg:grid-cols-12 lg:gap-12 lg:py-28">
          ...
          <div className="reveal lg:col-span-7 lg:col-start-6">
            <p className="text-lead text-ink first-letter:float-left first-letter:mt-1 first-letter:mr-3 first-letter:font-display first-letter:text-[4.25rem] first-letter:leading-[0.74] first-letter:text-rust-deep">
            ...
            <div className="mt-8 grid gap-6 text-[0.9375rem] leading-relaxed text-muted sm:grid-cols-2">
              <p>
            ...
            <Link
              href="/over-ons"
              className="group mt-10 inline-flex min-h-11 items-center gap-3 font-mono text-[0.6875rem] tracking-[0.2em] text-ink uppercase"
            >
